...
DESCRIBE RECENSEMENT_OEUF;
DESCRIBE SUIVI_POIDS;
DESCRIBE MORTALITE;
DESCRIBE PRIX_ATODY;
DESCRIBE PRIX_SAKAFO;
DESCRIBE LOT;
DESCRIBE RACE;
DESCRIBE TRANSFORMATION_OEUF;


-- script du 18-03-26

ALTER TABLE TRANSFORMATION_OEUF
ADD COLUMN nb_lamokany INT DEFAULT 0;